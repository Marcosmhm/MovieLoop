...
export default function PersonOverview({ ...props }) {
  ...
  const biographyElements = biographyLines.map((line, index) => {
    if (line) {
      return (
        <>
          <p key={`biography-${index}-${line}`}>{line}</p>
        </>
      );
    }
  });
      ...
      <section className="person-overview-container">
        ...
        <div className="person-overview-info">
          ...
          <ul className="person-list">
            {props.knownFor && (
              <li>
                <span className="detail-li-title">Know For</span>
                <span className="detail-li-content">{props.knownFor}</span>
              </li>
            )}
            {props.birthDay && (
              <li>
                <span className="detail-li-title">Born</span>
                <span className="detail-li-content">{props.birthDay}</span>
              </li>
            )}
            {props.placeOfBirth && (
              <li>
                <span className="detail-li-title">Place of Birth</span>
                <span className="detail-li-content">{props.placeOfBirth}</span>
              </li>
            )}
          </ul>
