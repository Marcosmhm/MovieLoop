    ...
    <>
      <nav className="navbar-principal">
        ...
        <NavLink to="/movie">
          {({ isActive }) =>
            isActive ? (
              <PiFilmSlate size={32} color="#2779a7" />
            ) : (
              <PiFilmSlate size={32} />
            )
          }
        ...
        <NavLink to="/tv">
          {({ isActive }) =>
            isActive ? (
              <PiTelevisionSimpleBold size={32} color="#2779a7" />
            ) : (
        ...
        {loggedState === "false" || !loggedState ? (
          ...
          <>
            <NavLink to="/favorites">
              {({ isActive }) =>
                isActive ? (
                  <MdOutlineFavoriteBorder size={32} color="#2779a7" />
                ) : (
        ...
        {isModalOpen && (
          <SeachModal onClose={handleCloseModal} isOpen={isModalOpen} />
        )}
      </nav>
    </>
  );
